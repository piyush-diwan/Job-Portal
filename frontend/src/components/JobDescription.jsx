        ...
        const fetchSingleJob = async () => {
            try {
                ...
                if(res.data.success){
                    ...
                    console.log("Single Job fetched successfully:", res.data.job);
                }
            } catch (error) {
                console.log(error);
            }
    ...
    return (
        ...
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center gap-2 mt-4'>
                        ...
                        <Badge className={'text-[#7209b7] font-bold'} variant="ghost">Rs. {singleJob?.salary} Per Month</Badge>
                    </div>
                </div>
                <Button
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Salary: <span className='pl-4 font-normal text-gray-800'>Rs. {singleJob?.salary} Per Month</span></h1>
